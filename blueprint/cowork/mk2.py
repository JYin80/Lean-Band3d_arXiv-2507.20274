...
g4 = build(
 nodes=[
  ...
  ("sd","Q17 · lem:sum_decay + eq:latticesum_d3","ready",2),
  ("pt","Q11 · lem:propT 卷积界（K0,K2 已落地）","ready",2),
 ...
 edges=[("uk","nz"),("uk","sd"),("tail","pt"),("tail","ttk"),("part","tree"),("tree","pure"),
        ("ax1","nz","d"),("ax1","uk","d"),("ax1","pure","d"),("ax1","sd","d")],
